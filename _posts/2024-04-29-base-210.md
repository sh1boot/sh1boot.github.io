...
<svg width="100%" viewbox="0 0 630 185">
  <defs>
    ...
    {%- for i in (0..5) -%}
      <g id="digit_{{i}}_5a"> <use href="#spine" /> <use href="#segment_{{i | modulo: 5}}_5a" /> </g>
    {%- endfor -%}
    {%- for i in (0..6) -%}
      <g id="digit_{{i}}_6a"> <use href="#spine" /> <use href="#segment_{{i | modulo: 6}}_6a" /> </g>
    {%- endfor -%}
    {%- for i in (0..7) -%}
      <g id="digit_{{i}}_7a"> <use href="#spine" /> <use href="#segment_{{i | modulo: 7}}_7a" /> </g>
    {%- endfor -%}
    {%- for i in (0..209) -%}
      <g id="digit_{{i}}a">
        <use href="#spine" />
  ...
  {%- endfor -%}
  {%- for i in (0..6) -%}
  <use x="{{i | modulo: 15 | times: 50 | plus: 55}}" y="40" href="#digit_{{i}}_7a" />
  {%- endfor -%}
  {%- for i in (0..5) -%}
  <use x="{{i | modulo: 15 | times: 50 | plus: 55}}" y="100" href="#digit_{{i}}_6a" />
  {%- endfor -%}
  {%- for i in (0..4) -%}
  <use x="{{i | modulo: 15 | times: 50 | plus: 55}}" y="160" href="#digit_{{i}}_5a" />
  {%- endfor -%}
</svg>
...
<svg width="100%" viewbox="0 0 630 1100">
  ...
  {%- endfor -%}
  {%- for i in (0..17) -%}
  <text x="30" y="{{i | times: 60 | plus: 40}}" style="text-anchor:end">{{i|times:12}}</text>
  {%- endfor -%}
  ...
  <use x="{{i | modulo: 12 | times: 50 | plus: 55}}"
       ...
       href="#digit_{{i}}a" />
  <text x="{{i | modulo: 12 | times: 50 | plus: 55}}"
        y="{{i | divided_by: 12 | times: 60 | plus: 68}}"
        font-size="60%"
  > {{i}}
...
<svg width="100%" viewbox="0 0 630 185">
  <defs>
    ...
    {%- for i in (0..5) -%}
      <g id="digit_{{i}}_5b"> <use href="#spine" /> <use href="#segment_{{i | modulo: 5}}_5b" /> </g>
    {%- endfor -%}
    {%- for i in (0..6) -%}
      <g id="digit_{{i}}_6b"> <use href="#spine" /> <use href="#segment_{{i | modulo: 6}}_6b" /> </g>
    {%- endfor -%}
    {%- for i in (0..7) -%}
      <g id="digit_{{i}}_7b"> <use href="#spine" /> <use href="#segment_{{i | modulo: 7}}_7b" /> </g>
    {%- endfor -%}
    {%- for i in (0..209) -%}
      <g id="digit_{{i}}b">
        <use href="#spine" />
  ...
  {%- endfor -%}
  {%- for i in (0..6) -%}
  <use x="{{i | modulo: 15 | times: 50 | plus: 55}}" y="40" href="#digit_{{i}}_7b" />
  {%- endfor -%}
  {%- for i in (0..5) -%}
  <use x="{{i | modulo: 15 | times: 50 | plus: 55}}" y="100" href="#digit_{{i}}_6b" />
  {%- endfor -%}
  {%- for i in (0..4) -%}
  <use x="{{i | modulo: 15 | times: 50 | plus: 55}}" y="160" href="#digit_{{i}}_5b" />
  {%- endfor -%}
</svg>
...
* In this system addition mod 210 is trivial, and I suspect multiplication mod 210 should also be pretty easy.  The thing that's especially hard is figuring out the other digit.  Maybe there's something that can be combined with the digits to express magnitude?  Maybe the logarithm, so multiplication gets even easier?  I have a page open about discrete log, but surely there's no Clue in that. 
* divisibility tests by powers of primes?
